...
class TestBrowseTheWeb:
    ...
    @mock.patch("screenpy_selenium.abilities.browse_the_web.Firefox", spec=Firefox)
    ...
    @mock.patch("screenpy_selenium.abilities.browse_the_web.Safari", spec=Safari)
    ...
    @mock.patch("screenpy_selenium.abilities.browse_the_web.Remote", spec=Remote)
